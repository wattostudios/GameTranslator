...
**********************************************************************************************
**/
public class Plugin_Stranded2 extends ArchivePlugin {
...
**********************************************************************************************
**/
  public Plugin_Stranded2() {

    super("Stranded2","Stranded2");
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getFilePointer() < arcSize){
        ...
        //original,code
        resources[realNumFiles] = new Resource_Stranded2(original,code);
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      for (int i=0;i<numFiles;i++){
        ...
        if (text instanceof Resource_Stranded2){
          Resource_Stranded2 resource = (Resource_Stranded2)text;
