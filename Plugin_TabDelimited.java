...
**********************************************************************************************
**/
public class Plugin_TabDelimited extends ArchivePlugin {
...
**********************************************************************************************
**/
  public Plugin_TabDelimited() {

    super("TabDelimited","TabDelimited");
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getFilePointer() < arcSize){
        ...
        //columns
        resources[realNumFiles] = new Resource_TabDelimited(columns);
...
public Resource getBlankResource(){
  return new Resource_TabDelimited();
  }
...
**/
  public Object getColumnValue(Resource text, char code) {
    if (text instanceof Resource_TabDelimited){
      Resource_TabDelimited resource = (Resource_TabDelimited)text;
