...
**********************************************************************************************
**/
public class Plugin_Cars extends ArchivePlugin {
...
**/
  public Plugin_Cars() {
    ...
    setGames("Cars");
    setExtensions("bnx"); // MUST BE LOWER CASE
    setPlatforms("PC");
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getFilePointer() < arcSize){
        ...
        //original,code
        resources[realNumFiles] = new Resource_Cars(original,code);
  ...
  public void write(Resource[] resources, File path) {
    try {
      ...
      for (int i=0;i<numFiles;i++){
        ...
        if (text instanceof Resource_Cars){
          Resource_Cars resource = (Resource_Cars)text;
