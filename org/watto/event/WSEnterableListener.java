...
/**
**********************************************************************************************
Listens for key press events and passes them to the WSEnterableInterface
**********************************************************************************************
**/
public class WSEnterableListener implements KeyListener{

  /** The interface that handles the event **/
  WSEnterableInterface program;
...
**********************************************************************************************
**/
  public WSEnterableListener(WSEnterableInterface program){
...
/**
**********************************************************************************************
Calls <code>WSEnterableInterface.onKeyPress(c,e)</code> when a key is pressed
@param e the event that was triggered
**********************************************************************************************
**/
  public void keyReleased(KeyEvent e){
    program.onEnter((JComponent)e.getSource(),e);
    }
