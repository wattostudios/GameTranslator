...
/**
**********************************************************************************************
Listens for click events and passes them to the WSClickableInterface
**********************************************************************************************
**/
public class WSClickableListener implements MouseListener{

  /** The interface that handles the event **/
  WSClickableInterface program;
...
**********************************************************************************************
**/
  public WSClickableListener(WSClickableInterface program){
...
/**
**********************************************************************************************
Calls <code>WSClickableInterface.onClick(c,e)</code> when the component is clicked
@param e the event that was triggered
**********************************************************************************************
**/
  public void mouseClicked(MouseEvent e){
    program.onClick((JComponent)e.getSource(),e);
    }
